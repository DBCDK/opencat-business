...
var FBSAuthenticator = function () {
    ...
    function recordDataForRawRepo(record, userId, groupId) {
        Log.trace("Enter - FBSAuthenticator.recordDataForRawRepo(", record, ", ", userId, ", ", groupId, ")");
        var result = [];
        try {
            ...
            Log.trace("Exit - FBSAuthenticator.recordDataForRawRepo(", record, ")");
        }
    }
    ...
    function __recordDataForRawRepoCommonRecord(record, userId, groupId) {
        ...
        try {
            ...
            recId = correctedRecord.getValue(/001/, /a/);
