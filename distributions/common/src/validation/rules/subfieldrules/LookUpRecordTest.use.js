...
UnitTest.addFixture( "LookUpRecord", function( ) {
    ...
    var errorMessage = ResourceBundle.getStringFormat( bundle, "lookup.record.does.not.exist", "a1Val", "700600" );
    var errors1a = [{type:"ERROR", params:{url:"", message:errorMessage}}];
    ...
    var errorMessage = ResourceBundle.getStringFormat( bundle, "lookup.record.does.not.exist", "a1Val", "600200" );
    var errors1a = [{type:"ERROR", params:{url:"", message:errorMessage}}];
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["a1" ,"a2" ,"a3"] ,"requiredFieldAndSubfield" : "004a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["nonValidValue1" ,"nonValidValue2" ,"nonValidValue3"] ,"requiredFieldAndSubfield" : "004a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["nonValidValue1" ,"nonValidValue2" ,"a2"] ,"requiredFieldAndSubfield" : "004a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["a1" ,"a2" ,"a3"] ,"requiredFieldAndSubfield" : "005a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["a1" ,"a2" ,"a3"]  };
    ...
    var params = {"agencyId" :"870970", "requiredFieldAndSubfield" : "005a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" :{} ,"requiredFieldAndSubfield" : "005a" };
    ...
    var params = {"agencyId" :"870970", "allowedSubfieldValues" : ["a1" ,"a2" ,"a3"] ,"requiredFieldAndSubfield" : {} };
