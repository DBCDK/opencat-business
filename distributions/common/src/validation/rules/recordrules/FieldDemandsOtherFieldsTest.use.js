...
UnitTest.addFixture( "FieldDemandsOtherFields first", function( ) {
    ...
    Assert.equalValue( "FieldDemandsOtherFields with empty params obj" ,  FieldDemandsOtherFields.validateRecord( record, {}), error);
    ...
    Assert.equalValue( "FieldDemandsOtherFields with params but no sources obj" ,  FieldDemandsOtherFields.validateRecord( record, params), error);
    ...
    Assert.equalValue( "FieldDemandsOtherFields with params but no values in demands array" ,  FieldDemandsOtherFields.validateRecord( record, params), error);
    ...
    Assert.equalValue( "FieldDemandsOtherFields with params obj but no values in sources array" ,  FieldDemandsOtherFields.validateRecord( record, params), error);

    // ok testing
    params = {"sources" : ["001"], "demands" : ["001"]};
    Assert.equalValue("FieldDemandsOtherFields demand 001 and source 001",  FieldDemandsOtherFields.validateRecord(record, params),[]);
    params = {"sources" : ["004"], "demands" : ["001"]};
    Assert.equalValue("FieldDemandsOtherFields demand 004 and source 001",  FieldDemandsOtherFields.validateRecord(record, params),[]);
    params = {"sources" : ["005"], "demands" : ["001"]};
    Assert.equalValue("FieldDemandsOtherFields demand 005 and source 001",  FieldDemandsOtherFields.validateRecord(record, params),[]);
    params = {"sources" : ["005"], "demands" : ["005"]};
    Assert.equalValue("FieldDemandsOtherFields demand 005 and source 005",  FieldDemandsOtherFields.validateRecord(record, params),[]);
    params = {"sources" : ["001","002","003","004","101","102","103","104"], "demands" : ["001","002","003","004","101","102","103","104"]};
    Assert.equalValue("FieldDemandsOtherFields demand all and source all" ,  FieldDemandsOtherFields.validateRecord(record, params),[]);
    params = {"sources" : ["001","002","003","004","101","102","103","104","105"], "demands" : ["004"]};
    Assert.equalValue("FieldDemandsOtherFields demand 004 and source all +1",  FieldDemandsOtherFields.validateRecord(record, params),[]);
    ...
    Assert.equalValue( "FieldDemandsOtherFields source 001 and demands 001" ,  FieldDemandsOtherFields.validateRecord(record, params), error);
    ...
    Assert.equalValue( "FieldDemandsOtherFields demands 005 source 001,002" ,  FieldDemandsOtherFields.validateRecord(record, params), error);

    params = {"sources" : ["001", "005"], "demands" : ["005"]};
    error = [{type:"ERROR", urlForDocumentation: "", message: "Da f\xf8lgende felter er tilstede i posten : '001'  er f\xf8lgende felter obligatoriske og mangler : '005'."}];
    Assert.equalValue( "FieldDemandsOtherFields demands 005 source 001,005" ,  FieldDemandsOtherFields.validateRecord(record , params), error);

    params = {"sources" : ["001", "005","006","002"], "demands" : ["005"]};
    error = [{type:"ERROR", urlForDocumentation: "", message: "Da f\xf8lgende felter er tilstede i posten : '001,002'  er f\xf8lgende felter obligatoriske og mangler : '005'."}];
    Assert.equalValue( "FieldDemandsOtherFields demand 005 and source 001,005,006,002" ,  FieldDemandsOtherFields.validateRecord(record, params), error);
    ...
    Assert.equalValue( "FieldDemandsOtherFields demand 001 and source 001" ,  FieldDemandsOtherFields.validateRecord(record, params), error);
