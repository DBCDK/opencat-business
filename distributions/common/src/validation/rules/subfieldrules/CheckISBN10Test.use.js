...
UnitTest.addFixture( "CheckISBN10.validateSubfield", function() {
    ...
    SafeAssert.equal( "2 CheckISBN10.validateSubfield with invalid isbn10 number", CheckISBN10.validateSubfield( record, field, subfield2, params )[0], error2[0] );
    ...
    SafeAssert.equal( "3 CheckISBN10.validateSubfield with invalid isbn10 number", CheckISBN10.validateSubfield( record, field, subfield3, params )[0], error3[0] );
    ...
    SafeAssert.equal( "6 CheckISBN10.validateSubfield, valid isbn10 number with trailing x", CheckISBN10.validateSubfield( record, field, subfield6, params ), [] );
