...
docker run -t -d --name $DOCKER_IMAGE -e HOST_USER_ID=$(id -u) -e HOST_USER_GID=$(id -g) -v ${PWD}:/home/jsshell docker-metascrum.artifacts.dbccloud.dk/dbc-jsshell:java8 /bin/bash || die "Docker run"
