    ...
    function convertRuleTypeNameToFunction(typeName) {
        ...
        try {
            switch (typeName) {
                ...
                case "SubfieldRules.checkDK5Syntax":
                    return CheckDK5Syntax.validateSubfield;
                ...
                case "SubfieldRules.SubfieldValueExcludesOtherSubfields":
                    return SubfieldValueExcludesOtherSubfields.validateSubfield;
