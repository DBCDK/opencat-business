    ...
    function validateSubfield( record, field, subfield, params ) {
        ...
        try {
            ...
            if (subfieldValue.charAt(0) === 'M') {
                    ...
                    if ( ! ( ch >= '0' && ch <= '9' ) ) {
                        if ( ch === '-') {
                           if ( ix === 1 || ix === 11 ) {
                            ...
                            result.push( ValidateErrors.subfieldError( "TODO:fixurl", ResourceBundle.getStringFormat( bundle, "check.ismn.hyphenpos.error", subfieldName ) ) );
                            return result;
                        } else {
                ...
                if ( hyphens !== 3 ) {
                    result.push( ValidateErrors.subfieldError( "TODO:fixurl", ResourceBundle.getStringFormat( bundle, "check.ismn.hyphens.error", subfieldName ) ) );
                }
                if ( ix !== 13 ) {
                ...
                result = CheckEAN13.makeCheck( subfield, bundle, 'M' );
            }
            return result;
