...
var ValidateErrors = function() {
    ...
    that.fieldError = function( url, message ) {
        return {
            type: "CDTOValidationResponseSuccessEntryCollectionRecordFieldUnstructuredValidationError",
            params: {
                url: url,
                message: message
            }
    ...
    that.subfieldError = function( url, message ) {
        return {
            type: "CDTOValidationResponseSuccessEntryCollectionRecordFieldSubFieldUnstructuredValidationError",
            params: {
                url: url,
                message: message
            }
