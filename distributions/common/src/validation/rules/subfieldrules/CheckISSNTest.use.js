...
UnitTest.addFixture( "CheckISSN.validateSubfield", function() {
    ...
    SafeAssert.equal( "1 CheckISSN.validateSubfield with valid issn number", CheckISSN.validateSubfield( record, field, subfield1, params ), [] );
    ...
    SafeAssert.equal( "2 CheckISSN.validateSubfield with invalid issn number", CheckISSN.validateSubfield( record, field, subfield2, params )[0], error2[0] );
    ...
    SafeAssert.equal( "3 CheckISSN.validateSubfield with invalid issn number", CheckISSN.validateSubfield( record, field, subfield3, params )[0], error3[0] );
    ...
    SafeAssert.equal( "4 CheckISSN.validateSubfield with invalid issn number", CheckISSN.validateSubfield( record, field, subfield4, params )[0], error4[0] );
    ...
    SafeAssert.equal( "5 CheckISSN.validateSubfield with invalid issn number", CheckISSN.validateSubfield( record, field, subfield5, params )[0], error5[0] );

    var subfield6 = {'name': "issn", 'value': "0900-226X" };
    SafeAssert.equal( "6 CheckISSN.validateSubfield, valid issn number with trailing x", CheckISSN.validateSubfield( record, field, subfield6, params ), [] );
    ...
    SafeAssert.equal( "7 CheckISSN.validateSubfield with invalid issn number", CheckISSN.validateSubfield( record, field, subfield7, params )[0], error7[0] );
});
