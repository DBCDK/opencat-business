...
UnitTest.addFixture( "Test FieldsMandatory.validateRecord", function( ) {
    ...
    SafeAssert.equal( "1 testing with valid " + params00123 + " param", FieldsMandatory.validateRecord( record, params00123 ), [] );
    ...
    SafeAssert.equal( "2 testing with invalid " + params00124 + " param", FieldsMandatory.validateRecord( record, params00124 ), errorMissing004 );
    ...
    SafeAssert.equal( "3 testing with invalid " + errors + " param", FieldsMandatory.validateRecord( record, params00054 ), errors );
} );
