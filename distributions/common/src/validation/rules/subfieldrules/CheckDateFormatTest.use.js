...
UnitTest.addFixture("CheckDateFormat.validateSubfield - check *c", function () {
    ...
    SafeAssert.equal("Check *c - forkert datoformat - tekst", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d (short) - forkert datoformat - ikke dato", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d (short) - forkert datoformat - for 'stor' dato", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d - forkert datoformat - ikke dato", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d - forkert datoformat - for 'stor' dato", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *c - forkert længde - for lang", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *c - forkert længde - for kort", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *d 20161101"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *c - OK 1", CheckDateFormat.validateSubfield(record, field, subfield, params), []);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *c 19700101"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *c - OK 2", CheckDateFormat.validateSubfield(record, field, subfield, params), []);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *d 20161101112142"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *c - OK 3", CheckDateFormat.validateSubfield(record, field, subfield, params), []);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *c 19700101000000"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *c - OK 4", CheckDateFormat.validateSubfield(record, field, subfield, params), []);
});
...
UnitTest.addFixture("CheckDateFormat.validateSubfield - check *d", function () {
    ...
    SafeAssert.equal("Check *d (short) - forkert datoformat - tekst", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d (short) - forkert længde - for kort", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);
    ...
    SafeAssert.equal("Check *d (short) - forkert længde - for lang", CheckDateFormat.validateSubfield(record, field, subfield, params), [msg]);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *d 20161101"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *d (short) - OK 1", CheckDateFormat.validateSubfield(record, field, subfield, params), []);

    record = DanMarc2Converter.convertFromDanMarc2(RecordUtil.createFromString("001 00 *a 50984508 *b 710100 *c 19700101"));
    field = record.fields[0];
    subfield = field.subfields[2];
    SafeAssert.equal("Check *d (short) - OK 2", CheckDateFormat.validateSubfield(record, field, subfield, params), []);
});