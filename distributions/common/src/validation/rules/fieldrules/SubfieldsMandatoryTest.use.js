...
UnitTest.addFixture( "SubfieldsMandatory", function( ) {
    ...
    Assert.equalValue( "1 testing with valid a param", [], SubfieldsMandatory.validateField( record, field, paramsA ) );
    ...
    Assert.equalValue( "2 testing with NON valid f param", errorFmissing, SubfieldsMandatory.validateField( record, field, paramsF ) );

    var paramsABC = {
        'subfields' : ['a', 'b', 'c']
    };
    Assert.equalValue( "3 testing with valid a,b,c param", [], SubfieldsMandatory.validateField( record, field, paramsABC ) );

    errorFmissing = [ValidateErrors.fieldError( "TODO:url", errorMessage )];
    var paramsABF = {
        'subfields' : ['a', 'b', 'f']
    };
    Assert.equalValue( "4 testing with NON valid  " + paramsABF.subfields + " param", errorFmissing, SubfieldsMandatory.validateField( record, field, paramsABF ) );
    ...
    Assert.equalValue( "5 testing with NON valid  " + paramsAXY.subfields + " param", errorXY, SubfieldsMandatory.validateField( record, field, paramsAXY ) );
