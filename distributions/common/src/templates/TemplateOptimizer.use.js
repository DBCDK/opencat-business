...
UnitTest.addFixture( "TemplateOptimizer.optimizeField", function() {
    ...
    Assert.equalValue( "", TemplateOptimizer.optimizeField( field, fdDefs, sfDefs ), { url: undefined, rules: [], subfields: {} } );
    ...
    Assert.equalValue( "", TemplateOptimizer.optimizeField( field, fdDefs, sfDefs ), 
        { 
            url: undefined, 
            rules: [], 
            subfields: { 
    ...
    field = {
        ...
        // fails , Sune needs to look at this 010914
    // Assert.equalValue( "TODO: Sune change 3", TemplateOptimizer.optimizeField( field, fdDefs, sfDefs ), 
        // { 
            // url: undefined, 
            // rules: [ {
                // type: FieldRules.subFieldsMandatory,
    ...
    field = {
        ...
        // fails , Sune needs to look at this 010914
    // Assert.equalValue( "TODO: Sune change 5", TemplateOptimizer.optimizeField( field, fdDefs, sfDefs ), 
        // { 
            // url: undefined, 
            // rules: [ 
                // {
