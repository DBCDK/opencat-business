...
UnitTest.addFixture( CheckReference.validateSubfield, function( ) {
    ...
    //SafeAssert.equal( "8 CheckReference.validateSubfield error, valid value without forward slash but no field without 'å' subfield", CheckReference.validateSubfield( record, undefined, subfield ), errorMessage );
    //
    //record = {
    //    fields : [{
    //        name : '001', indicator : '00', subfields : []
