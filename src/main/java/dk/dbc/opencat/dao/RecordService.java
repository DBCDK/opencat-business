...
public class RecordService {
    ...
    public MarcRecord fetchRecord(String bibliographicRecordId, int agencyId) throws RecordServiceConnectorException, ScripterException {
        logger.entry(bibliographicRecordId, agencyId);
    ...
    public MarcRecord fetchMergedDBCRecord(String bibliographicRecordId, int agencyId) throws RecordServiceConnectorException, ScripterException {
        logger.entry(bibliographicRecordId, agencyId);
