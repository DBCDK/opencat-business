...
var RepeatableSubfields = function () {
     ...
     * @syntax RepeatableSubfields.validateFields ( record, field, params )
     * @param {object} record
     * @param {object} field
     ...
     * @return {object}
     * @example RepeatableSubfields.validateFields ( record, field, params )
     * @name RepeatableSubfields.validateFields
     * @method
     */

    function validateFields( record, field, params, settings ) {
        Log.trace( "Enter - RepeatableSubfields.validateFields ( ", record, ", ", field, ", ", params, ", ", settings, " )" );
        ...
        try {
            ...
            Log.trace( "Exit - RepeatableSubfields.validateFields (): ", result );
        }
    }
    return {
