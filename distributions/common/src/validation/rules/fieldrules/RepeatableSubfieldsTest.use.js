...
UnitTest.addFixture( "RepeatableSubfields", function( ) {
    ...
    Assert.equalValue( "repeatableSubfields testing with NON valid " + params1a.subfields + " param", errors1a, RepeatableSubfields.validateField( record, field, params1a ) );

    var params1b = {
        'subfields' : ['b']
    };
    Assert.equalValue( "repeatableSubfields testing with valid b" + params1b.subfields + " param", [], RepeatableSubfields.validateField( record, field, params1b ) );
    ...
    Assert.equalValue( "repeatableSubfields testing with valid ac " + params1ac.subfields + " param", errors1ac, RepeatableSubfields.validateField( record, field, params1ac ) );
