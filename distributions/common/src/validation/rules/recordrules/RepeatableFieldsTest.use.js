...
UnitTest.addFixture( "Test RepeatableFields.validateRecord", function( ) {
    ...
    Assert.equalValue( "1 testing with valid params and data", RepeatableFields.validateRecord( record1, params1 ), [] );
    ...
    Assert.equalValue( "2 testing with valid params, error in data", RepeatableFields.validateRecord( record2, params2 ), error2 );
    ...
    Assert.equalValue( "3 testing with valid params and data", RepeatableFields.validateRecord( record3, params3 ), [] );

    var record4 = {'fields': [{'name': '001'}]};
    var params4 = {'fields': ['002','003','004','005','006','007','008','009','010']};
    Assert.equalValue( "4 testing with valid params and data", RepeatableFields.validateRecord( record4, params4 ), [] );
    ...
    Assert.equalValue( "5 testing with valid params, error in data", RepeatableFields.validateRecord( record5, params5 ), error5 );

    var record6 = {'fields': [{'name': '001'}, {'name': '002'}, {'name': '003'}]};
    var params6 = {'fields': []};
    Assert.equalValue( "6 testing with valid params and data", RepeatableFields.validateRecord( record6, params6 ), [] );
} );
