...
var CheckLength = function () {
    ...
    function validateSubfield ( record, field, subfield, params ) {
        ...
        try {
            ...
            if ( params.hasOwnProperty( 'min' ) ) {
                ret = __checkLengthMin( subfield, params );
            }
            if ( ret.length === 0 && params.hasOwnProperty( 'max' ) ) {
                ret = __checkLengthMax( subfield, params );
            }
            return ret;
        } finally {
    ...
    function __checkLengthMin( subfield, params ) {
    ...
    function __checkLengthMax( subfield, params ) {
        var subfieldValueLength = subfield['value'].length;
        var subfieldName = subfield['name'];
