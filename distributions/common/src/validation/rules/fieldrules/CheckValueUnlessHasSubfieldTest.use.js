...
UnitTest.addFixture( "Test CheckValueUnlessHasSubfield", function() {
    ...
    var params = { subfield: "2" , values: ["eng"]};
    var field;
    ...
    Assert.equalValue( "Record with legal 041", CheckValueUnlessHasSubfield.validateField(record, field, params), []);
   ...
   marcRecord = new Record();
    ...
    field = record.fields[1];
    Assert.equalValue( "Record with illegal field 041a", CheckValueUnlessHasSubfield.validateField( record,field, params ), [ValidateErrors.fieldError( "TODO:fixurl", "Værdien 'kkk' er ikke en del af de valide værdier: 'eng'")]);
