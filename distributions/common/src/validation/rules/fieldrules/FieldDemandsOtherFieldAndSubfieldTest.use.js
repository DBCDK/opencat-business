...
UnitTest.addFixture( "Test FieldDemandsOtherFieldAndSubfield ", function( ) {
    ...
    SafeAssert.equal( "1 testing fieldDemandsOtherFieldAndSubfield with invalid 004 field", FieldDemandsOtherFieldAndSubfield.validateFields( rec, field, params ), errMissing004 );
    ...
    SafeAssert.equal( "2 testing fieldDemandsOtherFieldAndSubfield with invalid a,b,c subfields", FieldDemandsOtherFieldAndSubfield.validateFields( rec, field, params ), errMissingSubfieldABC );

    params = {
        field : "002", subfields : ["a", "b", "c"]
    }
    SafeAssert.equal( "3 testing fieldDemandsOtherFieldAndSubfield with valid params", FieldDemandsOtherFieldAndSubfield.validateFields( rec, field, params ), [] );
} );